-- Migration: Migrate Service Role Key source from notification_config to Supabase Vault
-- Author: Forensic Audit Expert / AI Coding Agent
-- Date: 2026-07-11
-- Purpose: Complete Phase 4B of the migration by sourcing service_role_key from vault.decrypted_secrets.
...
BEGIN
  ...
  -- O Push eh apenas um mechanism de entrega secundario e assincrono.
